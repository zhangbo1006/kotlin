...
internal fun typeStrToCompileTimeType(str: String) = when (str) {
    BYTE.name -> BYTE
    SHORT.name -> SHORT
    INT.name -> INT
    LONG.name -> LONG
...
internal fun evaluateUnaryAndCheck(name: String, type: CompileTimeType<*>, value: Any, tracer: () -> Unit = {}): Any? {
...
internal fun evaluateBinaryAndCheck(
    name: String,
