...
public class DefaultErrorMessages {
    ...
    static {
        ...
        MAP.put(NON_APPLICABLE_CALL_FOR_BUILDER_INFERENCE, "Non-applicable call for builder inference, please annotate its declaration with ''@BuilderInference'' annotation");
