...
class IrModuleToJsTransformer(private val backendContext: JsIrBackendContext) : BaseIrElementToJsNodeTransformer<JsNode, Nothing?> {
    ...
    private fun findModuleExports(module: IrModuleFragment, context: JsGenerationContext, internalModuleName: JsName): List<JsStatement> {
        ...
        return publicDeclarations.map { declaration ->
    ...
    private fun generateModule(module: IrModuleFragment): JsProgram {
        ...
        val exportStatements = findModuleExports(module, rootContext, internalModuleName)
