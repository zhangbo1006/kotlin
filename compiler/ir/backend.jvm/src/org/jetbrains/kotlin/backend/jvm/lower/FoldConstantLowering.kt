...
class FoldConstantLowering(private val context: JvmBackendContext) : IrElementTransformerVoid(), FileLoweringPass {
    ...
    companion object {
        ...
        init {
            // IrBuiltins
            registerBuiltinUnaryOp(BOOLEAN, IrBuiltIns.OPERATOR_NAME_NOT) { !it }

            registerBuiltinBinaryOp(DOUBLE, IrBuiltIns.OPERATOR_NAME_LESS) { a, b -> a < b }
            registerBuiltinBinaryOp(DOUBLE, IrBuiltIns.OPERATOR_NAME_LESS_OR_EQUAL) { a, b -> a <= b }
            registerBuiltinBinaryOp(DOUBLE, IrBuiltIns.OPERATOR_NAME_GREATER) { a, b -> a > b }
            registerBuiltinBinaryOp(DOUBLE, IrBuiltIns.OPERATOR_NAME_GREATER_OR_EQUAL) { a, b -> a >= b }
            registerBuiltinBinaryOp(DOUBLE, IrBuiltIns.OPERATOR_NAME_IEEE754_EQUALS) { a, b -> a == b }

            registerBuiltinBinaryOp(FLOAT, IrBuiltIns.OPERATOR_NAME_LESS) { a, b -> a < b }
            registerBuiltinBinaryOp(FLOAT, IrBuiltIns.OPERATOR_NAME_LESS_OR_EQUAL) { a, b -> a <= b }
            registerBuiltinBinaryOp(FLOAT, IrBuiltIns.OPERATOR_NAME_GREATER) { a, b -> a > b }
            registerBuiltinBinaryOp(FLOAT, IrBuiltIns.OPERATOR_NAME_GREATER_OR_EQUAL) { a, b -> a >= b }
            registerBuiltinBinaryOp(FLOAT, IrBuiltIns.OPERATOR_NAME_IEEE754_EQUALS) { a, b -> a == b }

            registerBuiltinBinaryOp(INT, IrBuiltIns.OPERATOR_NAME_LESS) { a, b -> a < b }
            registerBuiltinBinaryOp(INT, IrBuiltIns.OPERATOR_NAME_LESS_OR_EQUAL) { a, b -> a <= b }
            registerBuiltinBinaryOp(INT, IrBuiltIns.OPERATOR_NAME_GREATER) { a, b -> a > b }
            registerBuiltinBinaryOp(INT, IrBuiltIns.OPERATOR_NAME_GREATER_OR_EQUAL) { a, b -> a >= b }
            registerBuiltinBinaryOp(INT, IrBuiltIns.OPERATOR_NAME_EQEQ) { a, b -> a == b }

            registerBuiltinBinaryOp(LONG, IrBuiltIns.OPERATOR_NAME_LESS) { a, b -> a < b }
            registerBuiltinBinaryOp(LONG, IrBuiltIns.OPERATOR_NAME_LESS_OR_EQUAL) { a, b -> a <= b }
            registerBuiltinBinaryOp(LONG, IrBuiltIns.OPERATOR_NAME_GREATER) { a, b -> a > b }
            registerBuiltinBinaryOp(LONG, IrBuiltIns.OPERATOR_NAME_GREATER_OR_EQUAL) { a, b -> a >= b }
            registerBuiltinBinaryOp(LONG, IrBuiltIns.OPERATOR_NAME_EQEQ) { a, b -> a == b }
        }
    }
