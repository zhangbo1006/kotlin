    ...
    override fun lower(irClass: IrClass) {
        ...
        irClass.transformChildrenVoid(object : IrElementTransformerVoidWithContext() {
            ...
            private fun createClass(superType: IrType, invokableType: IrType): IrClass {
                ...
                val invoke = invokableClass.functions.single { it.name.toString() == "invoke" }
                ...
                subclass.declarations.addAll(arrayOf(invokableField, constructor, override))
                return subclass
            }
        })
